...
if ($l12_tipoliberacaoweb == 2) {
  ...
  //$sWhere .= "      and ((l11_licsituacao = 0)  or ( l11_licsituacao = 1                  ";
  $sWhere .= "      and ((l11_licsituacao = 0                  ";
		...
		<td width="20%" align= "top" valign="top">
			<table width="100%" border="0" align= "center" cellpadding="0" cellspacing="0">
				...
				for ($i = 0; $i < $linhas; $i++){
			    	...
			    	echo " 
				    <tr>
						<td width='100%' ><img src='imagens/seta.gif'><a class='links' href='licitacao.php?tipo=$l03_codigo&julgada=0' target='lic' >$l03_descr</a></td>
					</tr>
					<tr><td>&nbsp;</td></tr>";
			    }     	       
				?>
