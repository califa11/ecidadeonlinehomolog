...
<html>
    <head>
        <title>Prefeitura de Sete Lagoas</title>
...
if (db_getsession("DB_login") == "") {
    ...
    if ($w13_liberapedsenha == "t") {
        ?> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href="consulta_cgm.php" target="CentroPref">Consultar Login</a>&nbsp;&nbsp;
...
//#################################################################
		...
		";
                    ...
                    $sqlperfil = "select * from db_permherda where id_usuario=$_SESSION[id_externo]";
                    //echo "<br>$sqlperfil";
...
//$w13_liberaescritorios = 3;
        ...
        <tr height="800">
            <td colspan="3" width="100%" align="center">
                <br><br><br>
<!--<span style='color:green' >Caro(a) Servidor(a), lembre-se de se recadastrar nos relógios biométricos em sua unidade, pois a folha de ponto estará vinculada ao pagamento a partir de agosto/2013.</span> !-->
                <iframe id="CentroPref" name="CentroPref" src="centro_pref.php" width="100%" height="800px" frameborder="0">
