...
class cl_numpref { 
   ...
   var $campos = "
                 ...
                 k03_tipoanuparc = int4 = Tipo de Anulação 
                 ...
                 k03_reemissaorecibo = bool = Reemite Recibo 
                 ";
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->k03_tipoanuparc = ($this->k03_tipoanuparc == ""?@$GLOBALS["HTTP_POST_VARS"]["k03_tipoanuparc"]:$this->k03_tipoanuparc);
   ...
   function incluir ($k03_anousu,$k03_instit){ 
     ...
     if($this->k03_tipoanuparc == null ){ 
       $this->erro_sql = " Campo Tipo de Anulação nao Informado.";
       $this->erro_campo = "k03_tipoanuparc";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($this->k03_reciboprot == null ){ 
       $this->erro_sql = " Campo Tipo do Recibo do Protocolo nao Informado.";
     ...
     if($this->k03_regracnd == null ){ 
       $this->erro_sql = " Campo Regra paraEmissão CND nao Informado.";
     ...
     if($this->k03_reciboprotretencao == null ){ 
       $this->erro_sql = " Campo Tipo Recibo Retenção nao Informado.";
     ...
     if($this->k03_separajurmulparc == null ){ 
       $this->erro_sql = " Campo Separar jur e mul no parcelamento nao Informado.";
     ...
     if($this->k03_respcargo == null ){ 
       $this->k03_respcargo = "0";
     }
     if($this->k03_toleranciapgtoparc == null ){ 
       $this->erro_sql = " Campo Valor Tolerância Diferença Pagamento nao Informado.";
     ...
     if($this->k03_pgtoparcial == null ){ 
       $this->erro_sql = " Campo Ativa Pagamento Parcial nao Informado.";
     ...
     if($this->k03_reemissaorecibo == null ){ 
       $this->erro_sql = " Campo Reemite Recibo nao Informado.";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,318,11007,'','".AddSlashes(pg_result($resaco,0,'k03_tipoanuparc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($k03_anousu=null,$k03_instit=null) { 
     ...
     if(trim($this->k03_tipoanuparc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["k03_tipoanuparc"])){ 
       $sql  .= $virgula." k03_tipoanuparc = $this->k03_tipoanuparc ";
       $virgula = ",";
       if(trim($this->k03_tipoanuparc) == null ){ 
         $this->erro_sql = " Campo Tipo de Anulação nao Informado.";
         $this->erro_campo = "k03_tipoanuparc";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k03_tipoanuparc"]) || $this->k03_tipoanuparc != "")
           $resac = db_query("insert into db_acount values($acount,318,11007,'".AddSlashes(pg_result($resaco,$conresaco,'k03_tipoanuparc'))."','$this->k03_tipoanuparc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function excluir ($k03_anousu=null,$k03_instit=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,318,11007,'','".AddSlashes(pg_result($resaco,$iresaco,'k03_tipoanuparc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
