...
class cl_tipoisen { 
   ...
   var $campos = "
                 j45_tipo = int4 = Codigo 
                 j45_descr = varchar(40) = Descricao 
                 j45_tipois = int4 = Tipo Isencao 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->j45_tipois = ($this->j45_tipois == ""?@$GLOBALS["HTTP_POST_VARS"]["j45_tipois"]:$this->j45_tipois);
   ...
   function incluir ($j45_tipo){ 
     ...
     if($this->j45_tipois == null ){ 
       $this->erro_sql = " Campo Tipo Isencao nao Informado.";
       $this->erro_campo = "j45_tipois";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     $result = @pg_query("insert into tipoisen(
                                       j45_tipo 
                                      ,j45_descr 
                                      ,j45_tipois 
                                      ,j45_taxas 
   ...
   function alterar ($j45_tipo=null) { 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["j45_tipois"])){ 
       $sql  .= $virgula." j45_tipois = $this->j45_tipois ";
       $virgula = ",";
       if($this->j45_tipois == null ){ 
         $this->erro_sql = " Campo Tipo Isencao nao Informado.";
         $this->erro_campo = "j45_tipois";
     ...
     $sql .= " where  j45_tipo = $this->j45_tipo
";
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($j45_tipo=null) { 
     $this->atualizacampos(true);
     $result = @pg_exec(" delete from tipoisen
                    where  j45_tipo = $this->j45_tipo
                    ");
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
