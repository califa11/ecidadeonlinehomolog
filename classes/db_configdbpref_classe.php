...
class cl_configdbpref { 
   ...
   var $campos = "
                 ...
                 w13_diasvenccertidao = int4 = Dias de vencimento das certidoes 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->w13_diasvenccertidao = ($this->w13_diasvenccertidao == ""?@$GLOBALS["HTTP_POST_VARS"]["w13_diasvenccertidao"]:$this->w13_diasvenccertidao);
       ...
       $this->w13_exigecpfcnpj = ($this->w13_exigecpfcnpj == "f"?@$GLOBALS["HTTP_POST_VARS"]["w13_exigecpfcnpj"]:$this->w13_exigecpfcnpj);
   ...
   function incluir ($w13_instit){ 
     ...
     if($this->w13_diasvenccertidao == null ){ 
       $this->erro_sql = " Campo Dias de vencimento das certidoes nao Informado.";
       $this->erro_campo = "w13_diasvenccertidao";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     $sql = "insert into configdbpref(
                ...
                values (
                               ...
                               ,$this->w13_diasvenccertidao 
                               ,'$this->w13_emailadmin' 
                               ,'$this->w13_liberalancisssemmov' 
                               ,'$this->w13_exigecpfcnpj' 
                               ,$this->w13_regracnd 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1383,10729,'','".AddSlashes(pg_result($resaco,0,'w13_diasvenccertidao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       ...
       $resac = db_query("insert into db_acount values($acount,1383,13345,'','".AddSlashes(pg_result($resaco,0,'w13_exigecpfcnpj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($w13_instit=null) { 
     ...
     if(trim($this->w13_diasvenccertidao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["w13_diasvenccertidao"])){ 
       $sql  .= $virgula." w13_diasvenccertidao = $this->w13_diasvenccertidao ";
       $virgula = ",";
       if(trim($this->w13_diasvenccertidao) == null ){ 
         $this->erro_sql = " Campo Dias de vencimento das certidoes nao Informado.";
         $this->erro_campo = "w13_diasvenccertidao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->w13_exigecpfcnpj)!="" || isset($GLOBALS["HTTP_POST_VARS"]["w13_exigecpfcnpj"])){ 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["w13_diasvenccertidao"]) || $this->w13_diasvenccertidao != "")
           $resac = db_query("insert into db_acount values($acount,1383,10729,'".AddSlashes(pg_result($resaco,$conresaco,'w13_diasvenccertidao'))."','$this->w13_diasvenccertidao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["w13_exigecpfcnpj"]) || $this->w13_exigecpfcnpj != "")
           $resac = db_query("insert into db_acount values($acount,1383,13345,'".AddSlashes(pg_result($resaco,$conresaco,'w13_exigecpfcnpj'))."','$this->w13_exigecpfcnpj',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function excluir ($w13_instit=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1383,10729,'','".AddSlashes(pg_result($resaco,$iresaco,'w13_diasvenccertidao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         ...
         $resac = db_query("insert into db_acount values($acount,1383,13345,'','".AddSlashes(pg_result($resaco,$iresaco,'w13_exigecpfcnpj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
