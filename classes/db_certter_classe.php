...
class cl_certter { 
   ...
   function incluir ($v14_certid,$v14_parcel){ 
     ...
     $result = @pg_query("insert into certter(
                                       v14_certid 
                                      ,v14_parcel 
                                      ,v14_vlrhis 
                                      ,v14_vlrcor 
 ...
 and  v14_parcel = $this->v14_parcel
";
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($v14_certid=null,$v14_parcel=null) { 
     $this->atualizacampos(true);
     $result = @pg_exec(" delete from certter
                    where  v14_certid = $this->v14_certid
, v14_parcel = $this->v14_parcel
                    ");
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
