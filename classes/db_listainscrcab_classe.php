...
class cl_listainscrcab { 
   ...
   function incluir ($p11_codigo){ 
     ...
     if($p11_codigo == "" || $p11_codigo == null ){
       $result = @pg_query("select nextval('listainscrcab_p11_codigo_seq')"); 
       if($result==false){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,5168,'$this->p11_codigo','I')");
       $resac = pg_query("insert into db_acount values($acount,742,5168,'','".AddSlashes(pg_result($resaco,0,'p11_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,742,5169,'','".AddSlashes(pg_result($resaco,0,'p11_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,742,5170,'','".AddSlashes(pg_result($resaco,0,'p11_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,742,5171,'','".AddSlashes(pg_result($resaco,0,'p11_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,742,5172,'','".AddSlashes(pg_result($resaco,0,'p11_fechado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,742,5173,'','".AddSlashes(pg_result($resaco,0,'p11_processado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,742,5174,'','".AddSlashes(pg_result($resaco,0,'p11_contato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($p11_codigo=null) { 
     ...
     $sql .= " where  p11_codigo = $this->p11_codigo
";
     $resaco = $this->sql_record($this->sql_query_file($this->p11_codigo));
     if($this->numrows>0){       $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = pg_query("insert into db_acountkey values($acount,5168,'$this->p11_codigo','A')");
       if(isset($GLOBALS["HTTP_POST_VARS"]["p11_codigo"]))
         $resac = pg_query("insert into db_acount values($acount,742,5168,'".AddSlashes(pg_result($resaco,0,'p11_codigo'))."','$this->p11_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["p11_numcgm"]))
         $resac = pg_query("insert into db_acount values($acount,742,5169,'".AddSlashes(pg_result($resaco,0,'p11_numcgm'))."','$this->p11_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["p11_data"]))
         $resac = pg_query("insert into db_acount values($acount,742,5170,'".AddSlashes(pg_result($resaco,0,'p11_data'))."','$this->p11_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["p11_hora"]))
         $resac = pg_query("insert into db_acount values($acount,742,5171,'".AddSlashes(pg_result($resaco,0,'p11_hora'))."','$this->p11_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["p11_fechado"]))
         $resac = pg_query("insert into db_acount values($acount,742,5172,'".AddSlashes(pg_result($resaco,0,'p11_fechado'))."','$this->p11_fechado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["p11_processado"]))
         $resac = pg_query("insert into db_acount values($acount,742,5173,'".AddSlashes(pg_result($resaco,0,'p11_processado'))."','$this->p11_processado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["p11_contato"]))
         $resac = pg_query("insert into db_acount values($acount,742,5174,'".AddSlashes(pg_result($resaco,0,'p11_contato'))."','$this->p11_contato',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($p11_codigo=null) { 
     $resaco = $this->sql_record($this->sql_query_file($p11_codigo));
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5168,'$this->p11_codigo','E')");
         $resac = pg_query("insert into db_acount values($acount,742,5168,'','".AddSlashes(pg_result($resaco,$iresaco,'p11_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,742,5169,'','".AddSlashes(pg_result($resaco,$iresaco,'p11_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,742,5170,'','".AddSlashes(pg_result($resaco,$iresaco,'p11_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,742,5171,'','".AddSlashes(pg_result($resaco,$iresaco,'p11_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,742,5172,'','".AddSlashes(pg_result($resaco,$iresaco,'p11_fechado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,742,5173,'','".AddSlashes(pg_result($resaco,$iresaco,'p11_processado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,742,5174,'','".AddSlashes(pg_result($resaco,$iresaco,'p11_contato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
