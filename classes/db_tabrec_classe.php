...
class cl_tabrec { 
   ...
   var $campos = "
                 ...
                 k02_descr = char(15) = descricao da receita 
                 k02_drecei = varchar(40) = Descrição Receita 
   ...
   function incluir ($k02_codigo){ 
     ...
     if($this->k02_drecei == null ){ 
       $this->erro_sql = " Campo Descrição Receita nao Informado.";
     ...
     $result = @pg_query("insert into tabrec(
                                       k02_codigo 
                                      ,k02_tipo 
                                      ,k02_descr 
                                      ,k02_drecei 
   ...
   function alterar ($k02_codigo=null) { 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["k02_tipo"])){ 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["k02_descr"])){ 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["k02_drecei"])){ 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["k02_codjm"])){ 
...
";
   ...
   function excluir ($k02_codigo=null) { 
