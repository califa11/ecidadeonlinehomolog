...
class cl_procandamint { 
   ...
   var $campos = "
                 p78_sequencial = int8 = Cod. sequencial 
                 p78_codandam = int8 = Código andamento 
                 p78_data = date = Data 
   ...
   function incluir ($p78_sequencial){ 
     ...
     if($this->p78_despacho == null ){ 
       $this->erro_sql = " Campo Despacho Interno nao Informado.";
       $this->erro_campo = "p78_despacho";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($p78_sequencial == "" || $p78_sequencial == null ){
       $result = @pg_query("select nextval('procandamint_p78_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from procandamint_p78_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,6446,'$this->p78_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1059,6446,'','".AddSlashes(pg_result($resaco,0,'p78_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1059,6447,'','".AddSlashes(pg_result($resaco,0,'p78_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1059,6448,'','".AddSlashes(pg_result($resaco,0,'p78_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1059,6449,'','".AddSlashes(pg_result($resaco,0,'p78_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1059,6450,'','".AddSlashes(pg_result($resaco,0,'p78_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1059,6451,'','".AddSlashes(pg_result($resaco,0,'p78_despacho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1059,6523,'','".AddSlashes(pg_result($resaco,0,'p78_publico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1059,6535,'','".AddSlashes(pg_result($resaco,0,'p78_transint'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($p78_sequencial=null) { 
     ...
     if(trim($this->p78_despacho)!="" || isset($GLOBALS["HTTP_POST_VARS"]["p78_despacho"])){ 
       ...
       $virgula = ",";
       if(trim($this->p78_despacho) == null ){ 
         $this->erro_sql = " Campo Despacho Interno nao Informado.";
         $this->erro_campo = "p78_despacho";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6446,'$this->p78_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p78_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1059,6446,'".AddSlashes(pg_result($resaco,$conresaco,'p78_sequencial'))."','$this->p78_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p78_codandam"]))
           $resac = pg_query("insert into db_acount values($acount,1059,6447,'".AddSlashes(pg_result($resaco,$conresaco,'p78_codandam'))."','$this->p78_codandam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p78_data"]))
           $resac = pg_query("insert into db_acount values($acount,1059,6448,'".AddSlashes(pg_result($resaco,$conresaco,'p78_data'))."','$this->p78_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p78_hora"]))
           $resac = pg_query("insert into db_acount values($acount,1059,6449,'".AddSlashes(pg_result($resaco,$conresaco,'p78_hora'))."','$this->p78_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p78_usuario"]))
           $resac = pg_query("insert into db_acount values($acount,1059,6450,'".AddSlashes(pg_result($resaco,$conresaco,'p78_usuario'))."','$this->p78_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p78_despacho"]))
           $resac = pg_query("insert into db_acount values($acount,1059,6451,'".AddSlashes(pg_result($resaco,$conresaco,'p78_despacho'))."','$this->p78_despacho',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p78_publico"]))
           $resac = pg_query("insert into db_acount values($acount,1059,6523,'".AddSlashes(pg_result($resaco,$conresaco,'p78_publico'))."','$this->p78_publico',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p78_transint"]))
           $resac = pg_query("insert into db_acount values($acount,1059,6535,'".AddSlashes(pg_result($resaco,$conresaco,'p78_transint'))."','$this->p78_transint',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($p78_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6446,'$this->p78_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1059,6446,'','".AddSlashes(pg_result($resaco,$iresaco,'p78_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1059,6447,'','".AddSlashes(pg_result($resaco,$iresaco,'p78_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1059,6448,'','".AddSlashes(pg_result($resaco,$iresaco,'p78_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1059,6449,'','".AddSlashes(pg_result($resaco,$iresaco,'p78_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1059,6450,'','".AddSlashes(pg_result($resaco,$iresaco,'p78_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1059,6451,'','".AddSlashes(pg_result($resaco,$iresaco,'p78_despacho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1059,6523,'','".AddSlashes(pg_result($resaco,$iresaco,'p78_publico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1059,6535,'','".AddSlashes(pg_result($resaco,$iresaco,'p78_transint'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
