...
class cl_setor { 
   ...
   var $campos = "
                 ...
                 j30_aliter = float8 = Aliquota Territotial 
                 ";
   ...
   function incluir ($j30_codi){ 
     ...
     if($this->j30_aliter == null ){ 
       $this->erro_sql = " Campo Aliquota Territotial nao Informado.";
     ...
     $result = @pg_query("insert into setor(
                                       j30_codi 
                                      ,j30_descr 
                                      ,j30_alipre 
                                      ,j30_aliter 
   ...
   function alterar ($j30_codi=null) { 
     ...
     $sql .= " where  j30_codi = '$this->j30_codi'
";
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($j30_codi=null) { 
     $this->atualizacampos(true);
     $result = @pg_exec(" delete from setor
                    where  j30_codi = '$this->j30_codi'
                    ");
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
