...
class cl_proctransfer { 
   ...
   function incluir ($p62_codtran){ 
     ...
     if($p62_codtran == "" || $p62_codtran == null ){
       $result = @pg_query("select nextval('proctransfer_p62_codtran_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from proctransfer_p62_codtran_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,2474,'$this->p62_codtran','I')");
       $resac = pg_query("insert into db_acount values($acount,408,2474,'','".AddSlashes(pg_result($resaco,0,'p62_codtran'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,408,2475,'','".AddSlashes(pg_result($resaco,0,'p62_dttran'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,408,2476,'','".AddSlashes(pg_result($resaco,0,'p62_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,408,2477,'','".AddSlashes(pg_result($resaco,0,'p62_coddepto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,408,2478,'','".AddSlashes(pg_result($resaco,0,'p62_id_usorec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,408,2479,'','".AddSlashes(pg_result($resaco,0,'p62_coddeptorec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,408,6103,'','".AddSlashes(pg_result($resaco,0,'p62_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($p62_codtran=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,2474,'$this->p62_codtran','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p62_codtran"]))
           $resac = pg_query("insert into db_acount values($acount,408,2474,'".AddSlashes(pg_result($resaco,$conresaco,'p62_codtran'))."','$this->p62_codtran',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p62_dttran"]))
           $resac = pg_query("insert into db_acount values($acount,408,2475,'".AddSlashes(pg_result($resaco,$conresaco,'p62_dttran'))."','$this->p62_dttran',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p62_id_usuario"]))
           $resac = pg_query("insert into db_acount values($acount,408,2476,'".AddSlashes(pg_result($resaco,$conresaco,'p62_id_usuario'))."','$this->p62_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p62_coddepto"]))
           $resac = pg_query("insert into db_acount values($acount,408,2477,'".AddSlashes(pg_result($resaco,$conresaco,'p62_coddepto'))."','$this->p62_coddepto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p62_id_usorec"]))
           $resac = pg_query("insert into db_acount values($acount,408,2478,'".AddSlashes(pg_result($resaco,$conresaco,'p62_id_usorec'))."','$this->p62_id_usorec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p62_coddeptorec"]))
           $resac = pg_query("insert into db_acount values($acount,408,2479,'".AddSlashes(pg_result($resaco,$conresaco,'p62_coddeptorec'))."','$this->p62_coddeptorec',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p62_hora"]))
           $resac = pg_query("insert into db_acount values($acount,408,6103,'".AddSlashes(pg_result($resaco,$conresaco,'p62_hora'))."','$this->p62_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($p62_codtran=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,2474,'$this->p62_codtran','E')");
         $resac = pg_query("insert into db_acount values($acount,408,2474,'','".AddSlashes(pg_result($resaco,$iresaco,'p62_codtran'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,408,2475,'','".AddSlashes(pg_result($resaco,$iresaco,'p62_dttran'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,408,2476,'','".AddSlashes(pg_result($resaco,$iresaco,'p62_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,408,2477,'','".AddSlashes(pg_result($resaco,$iresaco,'p62_coddepto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,408,2478,'','".AddSlashes(pg_result($resaco,$iresaco,'p62_id_usorec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,408,2479,'','".AddSlashes(pg_result($resaco,$iresaco,'p62_coddeptorec'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,408,6103,'','".AddSlashes(pg_result($resaco,$iresaco,'p62_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
