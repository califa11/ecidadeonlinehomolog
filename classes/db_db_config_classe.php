...
class cl_db_config { 
   ...
   function incluir ($codigo){ 
     ...
     $result = @pg_query("insert into db_config(
                                       codigo 
                                      ,nomeinst 
                                      ,ender 
                                      ,munic 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,449,'$this->codigo','I')");
       $resac = pg_query("insert into db_acount values($acount,83,449,'','".pg_result($resaco,0,'codigo')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,450,'','".pg_result($resaco,0,'nomeinst')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,451,'','".pg_result($resaco,0,'ender')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,452,'','".pg_result($resaco,0,'munic')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,453,'','".pg_result($resaco,0,'uf')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,457,'','".pg_result($resaco,0,'telef')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,458,'','".pg_result($resaco,0,'email')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,459,'','".pg_result($resaco,0,'ident')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,460,'','".pg_result($resaco,0,'tx_banc')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,461,'','".pg_result($resaco,0,'numbanco')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,462,'','".pg_result($resaco,0,'url')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,463,'','".pg_result($resaco,0,'logo')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,464,'','".pg_result($resaco,0,'figura')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,465,'','".pg_result($resaco,0,'dtcont')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,466,'','".pg_result($resaco,0,'diario')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,467,'','".pg_result($resaco,0,'pref')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,468,'','".pg_result($resaco,0,'vicepref')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,469,'','".pg_result($resaco,0,'fax')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,470,'','".pg_result($resaco,0,'cgc')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,471,'','".pg_result($resaco,0,'cep')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,3411,'','".pg_result($resaco,0,'tpropri')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,3412,'','".pg_result($resaco,0,'tsocios')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,3413,'','".pg_result($resaco,0,'prefeitura')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
...
";
     ...
     if($this->numrows>0){       $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = pg_query("insert into db_acountkey values($acount,449,'$this->codigo','A')");
       if(isset($GLOBALS["HTTP_POST_VARS"]["codigo"]))
         $resac = pg_query("insert into db_acount values($acount,83,449,'".pg_result($resaco,0,'codigo')."','$this->codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["nomeinst"]))
         $resac = pg_query("insert into db_acount values($acount,83,450,'".pg_result($resaco,0,'nomeinst')."','$this->nomeinst',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["ender"]))
         $resac = pg_query("insert into db_acount values($acount,83,451,'".pg_result($resaco,0,'ender')."','$this->ender',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["munic"]))
         $resac = pg_query("insert into db_acount values($acount,83,452,'".pg_result($resaco,0,'munic')."','$this->munic',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["uf"]))
         $resac = pg_query("insert into db_acount values($acount,83,453,'".pg_result($resaco,0,'uf')."','$this->uf',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["telef"]))
         $resac = pg_query("insert into db_acount values($acount,83,457,'".pg_result($resaco,0,'telef')."','$this->telef',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["email"]))
         $resac = pg_query("insert into db_acount values($acount,83,458,'".pg_result($resaco,0,'email')."','$this->email',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["ident"]))
         $resac = pg_query("insert into db_acount values($acount,83,459,'".pg_result($resaco,0,'ident')."','$this->ident',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["tx_banc"]))
         $resac = pg_query("insert into db_acount values($acount,83,460,'".pg_result($resaco,0,'tx_banc')."','$this->tx_banc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["numbanco"]))
         $resac = pg_query("insert into db_acount values($acount,83,461,'".pg_result($resaco,0,'numbanco')."','$this->numbanco',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["url"]))
         $resac = pg_query("insert into db_acount values($acount,83,462,'".pg_result($resaco,0,'url')."','$this->url',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["logo"]))
         $resac = pg_query("insert into db_acount values($acount,83,463,'".pg_result($resaco,0,'logo')."','$this->logo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["figura"]))
         $resac = pg_query("insert into db_acount values($acount,83,464,'".pg_result($resaco,0,'figura')."','$this->figura',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["dtcont"]))
         $resac = pg_query("insert into db_acount values($acount,83,465,'".pg_result($resaco,0,'dtcont')."','$this->dtcont',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["diario"]))
         $resac = pg_query("insert into db_acount values($acount,83,466,'".pg_result($resaco,0,'diario')."','$this->diario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["pref"]))
         $resac = pg_query("insert into db_acount values($acount,83,467,'".pg_result($resaco,0,'pref')."','$this->pref',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["vicepref"]))
         $resac = pg_query("insert into db_acount values($acount,83,468,'".pg_result($resaco,0,'vicepref')."','$this->vicepref',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["fax"]))
         $resac = pg_query("insert into db_acount values($acount,83,469,'".pg_result($resaco,0,'fax')."','$this->fax',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["cgc"]))
         $resac = pg_query("insert into db_acount values($acount,83,470,'".pg_result($resaco,0,'cgc')."','$this->cgc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["cep"]))
         $resac = pg_query("insert into db_acount values($acount,83,471,'".pg_result($resaco,0,'cep')."','$this->cep',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["tpropri"]))
         $resac = pg_query("insert into db_acount values($acount,83,3411,'".pg_result($resaco,0,'tpropri')."','$this->tpropri',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["tsocios"]))
         $resac = pg_query("insert into db_acount values($acount,83,3412,'".pg_result($resaco,0,'tsocios')."','$this->tsocios',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["prefeitura"]))
         $resac = pg_query("insert into db_acount values($acount,83,3413,'".pg_result($resaco,0,'prefeitura')."','$this->prefeitura',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($codigo=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = pg_query("insert into db_acountkey values($acount,449,'$this->codigo','E')");
       $resac = pg_query("insert into db_acount values($acount,83,449,'','".pg_result($resaco,0,'codigo')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,450,'','".pg_result($resaco,0,'nomeinst')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,451,'','".pg_result($resaco,0,'ender')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,83,452,'','".pg_result($resaco,0,'munic')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
