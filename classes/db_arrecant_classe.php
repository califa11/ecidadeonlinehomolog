...
class cl_arrecant { 
   ...
   function incluir_arrecant($numpre,$numpar=0, $excluir_arrecad=true){
    $sql = "select *
            from arrecad
...
,k00_numdig
   ...
   function excluir_arrecant($numpre,$numpar=0, $excluir_arrecad=true){
    $sql = "select *
            from arrecant
            where k00_numpre=$numpre";
    if($numpar>0){
    ...
    if($result!=false && pg_numrows($result)>0){
      ...
      for($a=0; $a< $numrows; $a++){
        $result = @pg_query("insert into arrecad(
                                       k00_numpre
                                      ,k00_numpar
                                      ,k00_numcgm
                                      ,k00_dtoper
