...
class cl_empempaut { 
   ...
   function incluir ($e61_numemp){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,5664,'$this->e61_numemp','I')");
       $resac = pg_query("insert into db_acount values($acount,890,5664,'','".AddSlashes(pg_result($resaco,0,'e61_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,890,5665,'','".AddSlashes(pg_result($resaco,0,'e61_autori'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e61_numemp=null) { 
     ...
     $sql .= " where  e61_numemp = $this->e61_numemp
";
     $resaco = $this->sql_record($this->sql_query_file($this->e61_numemp));
     if($this->numrows>0){       $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = pg_query("insert into db_acountkey values($acount,5664,'$this->e61_numemp','A')");
       if(isset($GLOBALS["HTTP_POST_VARS"]["e61_numemp"]))
         $resac = pg_query("insert into db_acount values($acount,890,5664,'".AddSlashes(pg_result($resaco,0,'e61_numemp'))."','$this->e61_numemp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["e61_autori"]))
         $resac = pg_query("insert into db_acount values($acount,890,5665,'".AddSlashes(pg_result($resaco,0,'e61_autori'))."','$this->e61_autori',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($e61_numemp=null) { 
     $resaco = $this->sql_record($this->sql_query_file($e61_numemp));
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5664,'$this->e61_numemp','E')");
         $resac = pg_query("insert into db_acount values($acount,890,5664,'','".AddSlashes(pg_result($resaco,$iresaco,'e61_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,890,5665,'','".AddSlashes(pg_result($resaco,$iresaco,'e61_autori'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
