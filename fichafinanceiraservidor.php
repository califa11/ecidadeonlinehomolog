...
// if($iMatric == 26345 || $iMatric == 25042 || $iMatric == 26517  ){
...
<script>
  ...
  function js_imprimir(){
    ...
    jan = window.open('','iframemitContraCheque','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
    jan.moveTo(0,0);  
