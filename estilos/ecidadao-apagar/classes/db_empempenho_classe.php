...
// funcao do sql 
   function sql_query_notas ( $e60_numemp=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
     ...
     $sql .= "      inner join orcorgao     on  orcorgao.o40_anousu = orcdotacao.o58_anousu and  orcorgao.o40_orgao = orcdotacao.o58_orgao";
     $sql .= "      inner join orcunidade   on  orcunidade.o41_anousu = orcdotacao.o58_anousu and  orcunidade.o41_orgao = orcdotacao.o58_orgao and  orcunidade.o41_unidade = orcdotacao.o58_unidade";
     $sql .= "      left join empnota       on empnota.e69_numemp   = empempenho.e60_numemp ";
     $sql .= "      left join pagordemnota  on empnota.e69_codnota  = e71_codnota ";
     $sql .= "                             and pagordemnota.e71_anulado is false";
     $sql .= "      left   join pagordem    on pagordem.e50_codord = pagordemnota.e71_codord";
     $sql2 = "";
     if($dbwhere==""){
       if($e60_numemp!=null ){
         $sql2 .= " where empempenho.e60_numemp = $e60_numemp "; 
