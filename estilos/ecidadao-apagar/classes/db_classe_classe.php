...
class cl_classe { 
   ...
   function incluir ($q12_classe){ 
     ...
     $result = @pg_query("insert into classe(
                                       q12_classe 
                                      ,q12_descr 
                       )
                values (
   ...
   function alterar ($q12_classe=null) { 
     ...
     $virgula = "";
     if(isset($GLOBALS["HTTP_POST_VARS"]["q12_classe"])){ 
       $sql  .= $virgula." q12_classe = $this->q12_classe ";
       $virgula = ",";
       if($this->q12_classe == null ){ 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["q12_descr"])){ 
     ...
     $sql .= " where  q12_classe = $this->q12_classe
";
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($q12_classe=null) { 
     $this->atualizacampos(true);
     $result = @pg_exec(" delete from classe
                    where  q12_classe = $this->q12_classe
                    ");
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
