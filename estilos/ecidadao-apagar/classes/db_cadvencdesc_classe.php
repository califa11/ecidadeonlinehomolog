...
class cl_cadvencdesc { 
   ...
   var $campos = "
                 ...
                 q92_codbco = int4 = codigo do banco 
                 q92_codage = char(5) = codigo da agencia 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->q92_codbco = ($this->q92_codbco == ""?@$GLOBALS["HTTP_POST_VARS"]["q92_codbco"]:$this->q92_codbco);
       $this->q92_codage = ($this->q92_codage == ""?@$GLOBALS["HTTP_POST_VARS"]["q92_codage"]:$this->q92_codage);
   ...
   function incluir ($q92_codigo){ 
     ...
     if($this->q92_codbco == null ){ 
       $this->erro_sql = " Campo codigo do banco nao Informado.";
       $this->erro_campo = "q92_codbco";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     $result = @pg_query("insert into cadvencdesc(
                                       q92_codigo 
                                      ,q92_descr 
                                      ,q92_codbco 
                                      ,q92_codage 
   ...
   function alterar ($q92_codigo=null) { 
     ...
     $virgula = "";
     if(isset($GLOBALS["HTTP_POST_VARS"]["q92_codigo"])){ 
       $sql  .= $virgula." q92_codigo = $this->q92_codigo ";
       $virgula = ",";
       if($this->q92_codigo == null ){ 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["q92_descr"])){ 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["q92_codbco"])){ 
       $sql  .= $virgula." q92_codbco = $this->q92_codbco ";
       $virgula = ",";
       if($this->q92_codbco == null ){ 
         $this->erro_sql = " Campo codigo do banco nao Informado.";
         $this->erro_campo = "q92_codbco";
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["q92_codage"])){ 
       $sql  .= $virgula." q92_codage = '$this->q92_codage' ";
       $virgula = ",";
       if($this->q92_codage == null ){ 
         $this->erro_sql = " Campo codigo da agencia nao Informado.";
         $this->erro_campo = "q92_codage";
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["q92_tipo"])){ 
     ...
     $sql .= " where  q92_codigo = $this->q92_codigo
";
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($q92_codigo=null) { 
     $this->atualizacampos(true);
     $result = @pg_exec(" delete from cadvencdesc
                    where  q92_codigo = $this->q92_codigo
                    ");
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function sql_query ( $q92_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      inner join bancos  as a on   a.codbco = cadban.k15_codbco";
     $sql2 = "";
     if($dbwhere==""){
       if($q92_codigo!=null ){
