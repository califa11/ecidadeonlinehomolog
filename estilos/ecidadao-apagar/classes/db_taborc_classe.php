...
class cl_taborc { 
   ...
   var $campos = "
                 ...
                 k02_anousu = int4 = ano 
                 k02_estorc = varchar(12) = estrutural da receita 
                 ";
   ...
   function incluir ($k02_codigo,$k02_anousu){ 
      $this->atualizacampos();
     if($this->k02_estorc == null ){ 
       $this->erro_sql = " Campo estrutural da receita nao Informado.";
     ...
     $result = @pg_query("insert into taborc(
                                       k02_codigo 
                                      ,k02_anousu 
                                      ,k02_estorc 
                       )
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = " ($this->k02_codigo."-".$this->k02_anousu) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     $this->erro_sql = "Inclusao Efetivada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->k02_codigo."-".$this->k02_anousu;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     return true;
   ...
   function alterar ($k02_codigo=null,$k02_anousu=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where  k02_codigo = $this->k02_codigo
 and  k02_anousu = $this->k02_anousu
";
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($k02_codigo=null,$k02_anousu=null) { 
     ...
     $sql2 = "";
      ...
      $sql2 .= " k02_codigo = $this->k02_codigo ";
}
      if($this->k02_anousu != ""){
      if($sql2!=""){
        $sql2 .= " and ";
   ...
   // funcao do sql 
   function sql_query ( $k02_codigo=null,$k02_anousu=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from taborc ";
     $sql .= "      inner join tabrec  on  tabrec.k02_codigo = taborc.k02_codigo";
     $sql .= "      inner join tabrecjm  on  tabrecjm.k02_codjm = tabrec.k02_codjm";
     $sql2 = "";
     if($dbwhere==""){
       if($k02_codigo!=null ){
         $sql2 .= " where taborc.k02_codigo = $k02_codigo "; 
       } 
       if($k02_anousu!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " taborc.k02_anousu = $k02_anousu "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   // funcao do sql 
   function sql_query_file ( $k02_codigo=null,$k02_anousu=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
