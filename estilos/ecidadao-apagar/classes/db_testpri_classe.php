...
class cl_testpri { 
   ...
   function incluir ($j49_idbql,$j49_face){ 
     ...
     $result = @pg_query("insert into testpri(
                                       j49_idbql 
                                      ,j49_face 
                                      ,j49_codigo 
                       )
   ...
   function alterar ($j49_idbql=null,$j49_face=null) { 
     ...
     $sql .= " where  j49_idbql = $this->j49_idbql
 and  j49_face = $this->j49_face
";
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($j49_idbql=null,$j49_face=null) { 
     ...
     $sql2 = "";
      ...
      $sql2 .= " j49_idbql = $this->j49_idbql ";
}
      if($this->j49_face != ""){
      if($sql2!=""){
        $sql2 .= " and ";
      }
      $sql2 .= " j49_face = $this->j49_face ";
}
