...
class cl_loteam { 
   ...
   var $campos = "
                 j34_loteam = int4 = Loteamento 
                 j34_descr = varchar(40) = Descricao 
                 j34_areacc = float8 = Area Construida 
                 j34_areapc = float8 = Area Publica 
                 j34_areato = float8 = Area Total 
                 ";
   ...
   function incluir ($j34_loteam){ 
      $this->atualizacampos();
     if($this->j34_descr == null ){ 
       $this->erro_sql = " Campo Descricao nao Informado.";
       $this->erro_campo = "j34_descr";
       $this->erro_banco = "";
     ...
     if($this->j34_areapc == null ){ 
       $this->erro_sql = " Campo Area Publica nao Informado.";
     ...
     if($this->j34_areato == null ){ 
       $this->erro_sql = " Campo Area Total nao Informado.";
     ...
     if($j34_loteam == "" || $j34_loteam == null ){
       $result = @pg_query("select nextval('Loteam_j34_loteam_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from Loteam_j34_loteam_seq");
     ...
     $result = @pg_query("insert into loteam(
                                       j34_loteam 
                                      ,j34_descr 
                                      ,j34_areacc 
                                      ,j34_areapc 
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = " ($this->j34_loteam) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($j34_loteam=null) { 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["j34_loteam"])){ 
       ...
       $virgula = ",";
       if($this->j34_loteam == null ){ 
         $this->erro_sql = " Campo Loteamento nao Informado.";
         $this->erro_campo = "j34_loteam";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
     ...
     $sql .= " where  j34_loteam = $this->j34_loteam
";
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($j34_loteam=null) { 
     $this->atualizacampos(true);
     $result = @pg_exec(" delete from loteam
                    where  j34_loteam = $this->j34_loteam
                    ");
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
