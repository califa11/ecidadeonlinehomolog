...
class cl_caracter { 
   ...
   var $campos = "
                 j31_codigo = int4 = Caracteristica 
                 j31_descr = varchar(40) = Descricao 
   ...
   function incluir ($j31_codigo){ 
     ...
     $result = @pg_query("insert into caracter(
                                       j31_codigo 
                                      ,j31_descr 
                                      ,j31_grupo 
                                      ,j31_pontos 
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = " ($this->j31_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($j31_codigo=null) { 
     ...
     $sql .= " where  j31_codigo = $this->j31_codigo
";
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($j31_codigo=null) { 
     $this->atualizacampos(true);
     $result = @pg_exec(" delete from caracter
                    where  j31_codigo = $this->j31_codigo
                    ");
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
