...
class cl_procandam { 
   ...
   var $campos = "
                 p61_codandam = int8 = Código andamento 
   ...
   function incluir ($p61_codandam){ 
     ...
     if($p61_codandam == "" || $p61_codandam == null ){
       $result = @pg_query("select nextval('procandam_p61_codandam_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from procandam_p61_codandam_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,2468,'$this->p61_codandam','I')");
       $resac = pg_query("insert into db_acount values($acount,407,2468,'','".AddSlashes(pg_result($resaco,0,'p61_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,407,2469,'','".AddSlashes(pg_result($resaco,0,'p61_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,407,2470,'','".AddSlashes(pg_result($resaco,0,'p61_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,407,2471,'','".AddSlashes(pg_result($resaco,0,'p61_dtandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,407,2472,'','".AddSlashes(pg_result($resaco,0,'p61_despacho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,407,2473,'','".AddSlashes(pg_result($resaco,0,'p61_coddepto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,407,6521,'','".AddSlashes(pg_result($resaco,0,'p61_publico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,407,6561,'','".AddSlashes(pg_result($resaco,0,'p61_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($p61_codandam=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,2468,'$this->p61_codandam','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p61_codandam"]))
           $resac = pg_query("insert into db_acount values($acount,407,2468,'".AddSlashes(pg_result($resaco,$conresaco,'p61_codandam'))."','$this->p61_codandam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p61_codproc"]))
           $resac = pg_query("insert into db_acount values($acount,407,2469,'".AddSlashes(pg_result($resaco,$conresaco,'p61_codproc'))."','$this->p61_codproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p61_id_usuario"]))
           $resac = pg_query("insert into db_acount values($acount,407,2470,'".AddSlashes(pg_result($resaco,$conresaco,'p61_id_usuario'))."','$this->p61_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p61_dtandam"]))
           $resac = pg_query("insert into db_acount values($acount,407,2471,'".AddSlashes(pg_result($resaco,$conresaco,'p61_dtandam'))."','$this->p61_dtandam',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p61_despacho"]))
           $resac = pg_query("insert into db_acount values($acount,407,2472,'".AddSlashes(pg_result($resaco,$conresaco,'p61_despacho'))."','$this->p61_despacho',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p61_coddepto"]))
           $resac = pg_query("insert into db_acount values($acount,407,2473,'".AddSlashes(pg_result($resaco,$conresaco,'p61_coddepto'))."','$this->p61_coddepto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p61_publico"]))
           $resac = pg_query("insert into db_acount values($acount,407,6521,'".AddSlashes(pg_result($resaco,$conresaco,'p61_publico'))."','$this->p61_publico',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["p61_hora"]))
           $resac = pg_query("insert into db_acount values($acount,407,6561,'".AddSlashes(pg_result($resaco,$conresaco,'p61_hora'))."','$this->p61_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($p61_codandam=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,2468,'$this->p61_codandam','E')");
         $resac = pg_query("insert into db_acount values($acount,407,2468,'','".AddSlashes(pg_result($resaco,$iresaco,'p61_codandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,407,2469,'','".AddSlashes(pg_result($resaco,$iresaco,'p61_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,407,2470,'','".AddSlashes(pg_result($resaco,$iresaco,'p61_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,407,2471,'','".AddSlashes(pg_result($resaco,$iresaco,'p61_dtandam'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,407,2472,'','".AddSlashes(pg_result($resaco,$iresaco,'p61_despacho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,407,2473,'','".AddSlashes(pg_result($resaco,$iresaco,'p61_coddepto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,407,6521,'','".AddSlashes(pg_result($resaco,$iresaco,'p61_publico'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,407,6561,'','".AddSlashes(pg_result($resaco,$iresaco,'p61_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
