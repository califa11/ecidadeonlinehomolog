...
class cl_issplaninscr { 
   ...
   function incluir ($q24_sequencial){ 
     ...
     if($q24_sequencial == "" || $q24_sequencial == null ){
       $result = @pg_query("select nextval('issplaninscr_q24_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from issplaninscr_q24_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,9193,'$this->q24_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1572,9193,'','".AddSlashes(pg_result($resaco,0,'q24_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1572,9194,'','".AddSlashes(pg_result($resaco,0,'q24_planilha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1572,9195,'','".AddSlashes(pg_result($resaco,0,'q24_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q24_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9193,'$this->q24_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q24_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1572,9193,'".AddSlashes(pg_result($resaco,$conresaco,'q24_sequencial'))."','$this->q24_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q24_planilha"]))
           $resac = pg_query("insert into db_acount values($acount,1572,9194,'".AddSlashes(pg_result($resaco,$conresaco,'q24_planilha'))."','$this->q24_planilha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q24_inscr"]))
           $resac = pg_query("insert into db_acount values($acount,1572,9195,'".AddSlashes(pg_result($resaco,$conresaco,'q24_inscr'))."','$this->q24_inscr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($q24_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9193,'$q24_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1572,9193,'','".AddSlashes(pg_result($resaco,$iresaco,'q24_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1572,9194,'','".AddSlashes(pg_result($resaco,$iresaco,'q24_planilha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1572,9195,'','".AddSlashes(pg_result($resaco,$iresaco,'q24_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
