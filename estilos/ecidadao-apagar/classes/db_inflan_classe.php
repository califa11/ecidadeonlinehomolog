...
class cl_inflan { 
   ...
   var $campos = "
                 ...
                 i01_dm = char(1) = se inflator é diario (1) ou mensal (0) 
   ...
   function incluir ($i01_codigo){ 
     ...
     if($this->i01_pict == null ){ 
       $this->erro_sql = " Campo picture nao Informado.";
       $this->erro_campo = "i01_pict";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($this->i01_dm == null ){ 
       $this->erro_sql = " Campo se inflator é diario (1) ou mensal (0) nao Informado.";
     ...
     $result = @pg_query("insert into inflan(
                                       i01_codigo 
                                      ,i01_descr 
                                      ,i01_pict 
                                      ,i01_dm 
   ...
   function alterar ($i01_codigo=null) { 
     ...
     $virgula = "";
     if(isset($GLOBALS["HTTP_POST_VARS"]["i01_codigo"])){ 
       $sql  .= $virgula." i01_codigo = '$this->i01_codigo' ";
       $virgula = ",";
       if($this->i01_codigo == null ){ 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["i01_descr"])){ 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["i01_pict"])){ 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["i01_dm"])){ 
     ...
     if(isset($GLOBALS["HTTP_POST_VARS"]["i01_tipo"])){ 
     ...
     $sql .= " where  i01_codigo = '$this->i01_codigo'
";
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($i01_codigo=null) { 
     $this->atualizacampos(true);
     $result = @pg_exec(" delete from inflan
                    where  i01_codigo = '$this->i01_codigo'
                    ");
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
