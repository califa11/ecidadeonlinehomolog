...
<div class="row">
  <div class="col-lg-12">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Informações do Imóvel</li>
  </ol>
</div>
<!-- /.col-lg-12 -->
<div class="row">
            ...
            <table class="table" cellpadding="0" cellspacing="0">
             <tr>
              <td class="tabfonte" valign="top" align="center">
               <strong style="font-size:15px">DADOS CADASTRAIS DO IMÓVEL</strong>
           </td>
       </tr>
       <tr>
...
<strong><br>
    CARACTERÍSTICAS DO IMÓVEL</strong> <table class="table"  cellpadding="0" cellspacing="0" style="text-transform: uppercase;">
    <?
    $controle = 1;
...
<font size="2" face="Arial, Helvetica, sans-serif"><strong><br>
  ISENÇÕES</strong></font> <table class="table"  cellpadding="0" cellspacing="0" >
  <?
...
<?=substr($j45_descr, 0, 20)?>
  ...
  ?>
  <tr>
      <td width="8%" align="center" nowrap class="tabfonte"><strong>Sem Isenções</strong></td>
    </tr>
    <?
}
?>
...
<font size="2" face="Arial, Helvetica, sans-serif"><strong><br>
  EDIFICAÇÕES ( Constru&ccedil;&otilde;es
  ...
  if( pg_numrows($result) != 0 ) {
      ...
      <tr>
          <td class="tabfonte" width="21%"><strong>Construção:</strong>
<?=$j39_idcons?>
</td>
...
<?=$j39_area?>
        ...
        <td class="tabfonte" width="25%" ><strong>Ano Construção:</strong>
<?=$j39_ano?>
</td>
...
<strong>
  ...
  echo "<tr>";
  echo " <td  align=\"center\">Imóvel Territorial</td>";
  echo "</tr>";
  echo "</table>";
}
?>
