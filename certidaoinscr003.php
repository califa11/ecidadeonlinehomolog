...
//$sqlMenupref .= "           WHERE m_arquivo = 'certidaoinscr003.php'   ";
//$sqlMenupref .= "        ORDER BY m_descricao                          ";
//
//$result       = pg_query($sqlMenupref);
...
// verifica se está logado
  if(( @$id_usuario!="" ) && !isset($outro)){
   ...
   $result  = $clescrito->sql_record($clescrito->sql_query("",
                                                           "q02_inscr,a.z01_nome as z01_nome,a.z01_cgccpf as z01_cgccpf","a.z01_nome",
