...
if($instituicao!=1){
  echo "Caro Servidor(a) favor procurar o Departamento Pessoal da sua instituição, seu comprovante de rendimentos será entregue pessoalmente.";
  exit();
}
...
switch ($tipo) {
  ...
  case 'm':
      ...
      if (isset($matric) && !empty($matric)) {
		...
		//$sMatriculas = str_replace("23358","25086",$sMatriculas);
...
$sSqlRendimento .= "                        and rh98_rhdirfgeracaodadospessoal = x.rh96_sequencial";
$sSqlRendimento .= "                        and rh98_mes between 1 and 13 ";
...
$sSqlRendimento .= "                        and rh98_rhdirfgeracaodadospessoal = x.rh96_sequencial ";
$sSqlRendimento .= "                        and rh98_mes between 1 and 13 ";
$sSqlRendimento .= "                  ),0) as outros_classificacao_rio,      ";
...
for ($iInd = 0; $iInd < $iNumRows; $iInd++) {
  ...
  $pdf1->w_outros5       = $oRendimento->molestia_grave_ativos + $oRendimento->outros_classificacao_rio;
