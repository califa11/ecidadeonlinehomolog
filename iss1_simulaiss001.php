...
function js_simular() {
  ...
  $$('#atividades tr').each( function(oLinha, iSeqAtividade){ 
    ...
    if (oLinha.id != "headerAtividades") {
      ...
      var iAtividade = oLinha.cells[0].firstChild.getValue();
      var oAtividade = new Object();
      oAtividade.iCodigoAtividade = oLinha.cells[0].firstChild.getValue();
      oAtividade.iQuantidade      = oLinha.cells[3].firstChild.getValue();
	...
	oParam.sRazaoSocial        = $F('z01_nome');
...
function js_lancar() {
  ...
  var oInput             = document.createElement("input");
      oInput.type        = 'radio';
		  ...
		  oInput.value       = iCodigoAtividade;
		  oInput.setAttribute("onClick", "js_defineAtividadePrincipal(" +iCodigoAtividade+ ")");
  ...
  var oInput                = document.createElement("input");
      oInput.type           = 'button';
		  ...
		  oInput.value          = 'E';
		  oInput.setAttribute("onclick", "js_excluirAtividade(this.parentNode.parentNode, "+iCodigoAtividade+" )");   	  
